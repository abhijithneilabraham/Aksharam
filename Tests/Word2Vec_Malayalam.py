...
sentences = [['പ്രളയപുനര്‍നിര്‍മാണം', 'പരിസ്ഥിതി', 'സൗഹൃദമാക്കണമെന്ന്‌', 'മുഖ്യമന്ത്രി','പിണറായി','വിജയൻ','പറഞ്ഞു'],
			...
			['ഓരോരുത്തര്‍ക്കും','തോന്നിയ','പോലെ','മണ്ണില്‍','ഇടപെടുന്ന','സ്ഥിതിക്ക്','അച്ഛൻ','അമ്മ']]#Processed Newspaper article
# train model
...
for i, word in enumerate(words):
	pyplot.annotate(i, xy=(result[i, 0], result[i, 1])) #Plotting points corresponding to its vector
	print(i," ",word)
pyplot.show()
